...
author: "Graham Chickering, Lorraine Oloo, Zac Miller"
date: "Add a date"
output:
  rmdformats::material:
    thumbnails: false
...
- go to https://stat231-s21.github.io/Blog-The-Naturers/ to see the published test document (this is publicly available!)
...
You can include [Links](https://www.datadreaming.org/post/r-markdown-theme-gallery/) and images ![team logo](https://raw.githubusercontent.com/stat231-s21/Blog-The-Naturers/main/images/s2g4-environment.png)
